...
class CategoryDetail extends LitElement {
  ...
  async connectedCallback() {
    ...
    console.log("CategoryDetail connected with mode:", this.mode);
    console.log("CategoryDetail connected with ID:", this.categoryId);

    // Get mode from URL if not set via attribute
    const urlParams = new URLSearchParams(window.location.search);
    const modeParam = urlParams.get("mode");
    if (modeParam) {
      this.mode = modeParam;
      console.log("Mode updated from URL:", this.mode);
    }
  ...
  render() {
    console.log("Rendering CategoryDetail with mode:", this.mode);
    ...
    if (this.mode === "edit") {
      return html`
        ...
        <script type="module">
          import "/static/js/components/admin/category-form.js";
        </script>
      `;
    } else {
      return html`
