...
class SaleProductCard extends LitElement {
  ...
  handleCardClick() {
    window.location.href = `/sale/${this.product.id}`;
  }
  ...
  render() {
    ...
    return html`
      <div class="product-card sale-product" @click=${this.handleCardClick}>
        <div
          class="product-background"
          style="background-image: ${backgroundStyle}; backdrop-filter: blur(8px);"
        ></div>

        <div class="product-type-indicator sale">Sale</div>
